...
const styles = StyleSheet.create({
  ...
  identTitle: { fontSize: FONT_BASE, color: COLORS.TEXT_PRIMARY },
  identValue: { fontWeight: '700', color: COLORS.PRIMARY },
  ...
  stepText: { fontSize: FONT_BASE, color: COLORS.TEXT_PRIMARY, textAlign: 'center' },
  barBg: {
    width: '80%', height: 8, backgroundColor: '#E0E0E0',
    borderRadius: 4, overflow: 'hidden',
  },
  barFill: { height: '100%', backgroundColor: COLORS.PRIMARY, borderRadius: 4 },
  pctText: { fontSize: FONT_SM, color: COLORS.TEXT_SECONDARY },
  ...
  errorTitle: { fontSize: FONT_LG, fontWeight: '700', color: '#C62828' },
  ...
  labelTitle: { fontSize: FONT_BASE, fontWeight: '600', color: COLORS.TEXT_PRIMARY, marginBottom: SPACING_SM },
  ...
  labelBtnText: { fontSize: FONT_SM, color: COLORS.TEXT_SECONDARY },
  ...
  savedText: { color: '#2D7A4F', fontWeight: '600' },

  backBtn: { alignItems: 'center', paddingVertical: SPACING_LG, marginTop: SPACING_SM },
  backText: { color: COLORS.TEXT_SECONDARY, fontSize: FONT_SM },
});
